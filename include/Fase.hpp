...
//    virtual EntidadeColidivel* criarBlocoChao(float pos_x, float pos_y, float escala, std::string caminho);
    virtual EntidadeColidivel* criarBlocoChao(float, float, float, std::string);
//    EntidadeColidivel* criarCaixaMadeira(float pos_x = 0.0f, float pos_y = 0.0f);
    EntidadeColidivel* criarCaixaMadeira(float = 0.0f, float = 0.0f);
//    EntidadeColidivel* criarCaixaMadeira(float, float);
